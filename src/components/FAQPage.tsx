...
const FAQPage: React.FC = () => {
  ...
  const faqs: FAQ[] = [
    {
      question: 'מה זה יוצר סיכומי וידאו ואיך זה עוזר לי?',
      answer: 'יוצר סיכומי וידאו הוא כלי מתקדם שמנתח וידאו ארוך ויוצר ממנו סיכום קצר ומרוכז. זה מושלם ליוצרי תוכן שרוצים לחסוך זמן, לבלוגרים שרוצים לקצר הרצאות, ולכל מי שצריך להפוך תוכן ארוך לנגיש יותר. הכלי שלנו משתמש בבינה מלאכותית כדי לזהות את הקטעים החשובים ביותר ולחבר אותם לסיכום קוהרנטי.'
    },
    {
      question: 'איך הטכנולוגיה שלכם עובדת?',
      answer: 'אנחנו משתמשים בשילוב של טכנולוגיות מתקדמות: מנוע FFmpeg לעיבוד וידאו מקצועי, בינה מלאכותית של Google Gemini לניתוח תוכן ויצירת תסריט, וטכנולוגיית Web Speech API לקריינות. כל התהליך מתבצע בצורה אוטומטית ומהירה, תוך שמירה על איכות גבוהה.'
    },
    {
    ...
    },
    {
      ...
      answer: 'כרגע אנחנו תומכים בקבצים עד 2GB ובאורך של עד 3 שעות. אם יש לך קובץ גדול יותר, תוכל לדחוס אותו באמצעות תוכנות דחיסת וידאו או לפנות אלינו לפתרון מותאם. אנו עובדים על הגדלת מגבלות אלו בעתיד.'
    },
    {
        ...
        >
          <div className="text-center">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => {
                // כאן תוכל להוסיף נווט לעמוד צור קשר
